    ...
    <BrowserRouter>
      <div>
        ...
        <footer className="footer">
          <p>Contactez-moi : lachgar.m@gmail.com | [numéro de téléphone]</p>
        </footer>
      </div>
    </BrowserRouter>
  );
